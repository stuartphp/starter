                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-auto d-flex gap-2">
                        <x-bs::dropdown-start icon="bolt">
                            <x-bs::dropdown-item :label="__('Read')" click="$emit('showModal', 'dummy.prefix.read', {{ $dummyModelVariable->id }})"/>
                            <x-bs::dropdown-item :label="__('Update')"  click="$emit('showModal', 'dummy.prefix.save', {{ $dummyModelVariable->id }})"/>
                            <x-bs::dropdown-item :label="__('Password')" click="$emit('showModal', 'dummy.prefix.password', {{ $dummyModelVariable->id }})"/>
                            <x-bs::dropdown-item :label="__('Delete')"  click="delete({{ $dummyModelVariable->id }})" confirm/>
                        </x-bs::dropdown-start>
                    </div>
                </div>
            </div>
